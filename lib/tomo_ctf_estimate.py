...
def write_sorted_mic_star(folder, input_files,  use_tilt_order_files, custom_tilt_order, tilt_scheme, min_angle, angle_step, starting_tilt_angle, tomo_name, write_tilt_order_files, mic_id,dose_symmetric_group_size,dose_symmetric_groups_not_centered):
    ...
    order_list, doses_list, tilt_order_path, used_custom_or_file_tilt_order = parse_tilt_order_and_dose(folder, False, False, use_tilt_order_files,
                                                                        ...
                                                                        None, None, write_tilt_order_files,dose_symmetric_group_size,dose_symmetric_groups_not_centered)
...
def main(input_files, input_folders, mic_star, tomo_name, tilt_scheme, min_angle, angle_step, pixel_size, only_make_sorted_mic_star, only_do_unfinished,
    ...
    if mic_star == None:
        ...
        for folder in folder_list:
            ...
            tomo_mic_md, mic_id = write_sorted_mic_star(folder, input_files, use_tilt_order_files, custom_tilt_order, tilt_scheme, min_angle, angle_step, starting_tilt_angle, tomo_name, write_tilt_order_files, mic_id, dose_symmetric_group_size, dose_symmetric_groups_not_centered)
